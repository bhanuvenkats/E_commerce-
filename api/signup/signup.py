...
from api.signup.schemas import SignupRequest, SignupResponse, ErrorResponse
from api.utils import get_db_pool, hash_password, is_password_strong, generate_uuid
...
async def signup(
    ...
    async with pool.acquire() as conn:
        ...
        user_data = {
            ...
            "role": getattr(payload, "role", "customer")
        }
        ...
        except asyncpg.exceptions.UniqueViolation as e:
        ...
        logging.info(f"[signup] User created successfully: id={created_id}")
        return SignupResponse(user_id=created_id, message="User registered.")
